...
public class frmMantenimientoTipoCuentas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsTipoCuentas> listadoTipoCuenta = cuenta.getListadoTipoCuentas();
        tablaTipoCuentas.setModel(modelo);
    ...
    private void initComponents() {
        ...
        tablaTipoCuentas = new javax.swing.JTable();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Mantenimiento Tipo Cuentas");
        setVisible(true);
        ...
        txtDes.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtDes.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(204, 204, 204)));
        ...
        tablaTipoCuentas.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        tablaTipoCuentas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaTipoCuentas);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtDes, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(label1)
                        .addGap(294, 534, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsTipoCuentas cuenta= new clsTipoCuentas();
        cuenta.setTipoCueId(Integer.parseInt(txtbuscado.getText()));
        registrosBorrados=cuenta.setBorrarTipoCuenta(cuenta);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsTipoCuentas cuenta = new clsTipoCuentas();
        cuenta.setTipoCueId(Integer.parseInt(txtId.getText()));
        cuenta.setTipoCueDescripcion(txtDes.getText());
        int contador = 0;
        ...
        if (contador == 1) {
            cuenta.setIngresarTipoCuenta(cuenta);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        cuenta.setTipoCueId(Integer.parseInt(txtbuscado.getText()));        
        cuenta = cuenta.getBuscarInformacionTipoCuentaPorId(cuenta);
        System.out.println("Cuenta retornada:" + cuenta);        
        txtDes.setText(cuenta.getTipoCueDescripcion());
        rbHabilitado.setSelected(cuenta.getEstatusTipoCue().equals("T"));
        rbDeshabilitado.setSelected(cuenta.getEstatusTipoCue().equals("F"));
        int resultadoBitacora=0;
        clsBitacora bitacoraRegistro = new clsBitacora();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (!estatusBanco.isEmpty()) {
            contador++;
            cuenta.setEstatusTipoCue(estatusBanco);
        }
        if (contador == 1) {
            cuenta.setModificarTipoCuenta(cuenta);
    ...
    private javax.swing.JTable tablaTipoCuentas;
