 ...
 * @author visitante
 */
public class frmMantenimientoModulo extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsModulo usuario = new clsModulo();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsModulo> listaUsuarios = usuario.getListadoUsuarios();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsModulo usuario = new clsModulo();
        usuario.setNombreModulo(txtNombre.getText());
        usuario.setEstatusModulo(txtContrasena.getText());
        usuario.setIngresarModulo(usuario);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        usuario.setIdModulo(Integer.parseInt(txtbuscado.getText()));        
        usuario = usuario.getBuscarInformacionModuloPorId(usuario);
        System.out.println("Modulo retornado:" + usuario);        
        txtNombre.setText(usuario.getNombreModulo());
        txtContrasena.setText(usuario.getEstatusModulo());
